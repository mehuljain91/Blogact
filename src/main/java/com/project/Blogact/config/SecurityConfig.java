package com.project.Blogact.config;

import com.project.Blogact.model.User;
import com.project.Blogact.service.UserService;
import com.project.Blogact.util.BlogReactiveUserDetailsService;
    ...
    public ApplicationRunner applicationRunner() {
        return args -> {
            ...
            userService.save(new User(UUID.randomUUID().toString(), "user",
                    passwordEncoder().encode("password"), "USER", "User of Blog"));
            userService.save(new User(UUID.randomUUID().toString(), "admin",
                    passwordEncoder().encode("password"), "ADMIN", "Admin of Blog"));
        };
    }
}
